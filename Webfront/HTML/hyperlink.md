...
<body>
    ...
    <hr>
    <h3>다른 문서로 이동</h3>
    <a href="02_text.html">text</a>
    <hr>
    <h3>동일 문서 내 다른 영역으로 이동</h3>
    <a href="#javascript">id가 javascript인 태그 영역으로 이동</a><br>
    <a href="#jQuery">id가 jQuery인 태그 영역으로 이동</a><br>
    <a href="#CSS">id가 CSS인 태그 영역으로 이동</a><br>
